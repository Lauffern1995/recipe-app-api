...
class PrivateRecipeApiTests(TestCase):
    ...
    def test_partial_update(self):
        """ Test partial update of na recipe"""
    ...
    def test_full_update(self):
        ...
        payload = {
            ...
            'time_minutes': 45,
            'price': Decimal('69.40'),
            'description': 'Updated Sample Desc',
    ...
    def test_create_recipe_with_existing_tags(self):
        """Test creating a recipe with a exisiting tag"""
    ...
    def test_create_tag_on_update(self):
        """Test creating update tag when updating a recipe"""
        recipe = create_recipe(user=self.user)
    ...
    def test_update_recipe_assign_ingredient(self):
        '''Test assinging an exsisting ingredient when updating a recipe'''
    ...
    def test_filter_by_ingredients(self):
        ...
        r2 = create_recipe(user=self.user, title='Chicken Parm')
        in1 = Ingredient.objects.create(user=self.user, name='Bean')
        in2 = Ingredient.objects.create(user=self.user, name='Parm')
